    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col items-center pt-16 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-slate-600 text-lg max-w-xl">
          Acorta tus URLs en segundos y comparte enlaces más elegantes y fáciles de recordar.
        </p>
      </div>
      ...
      <div className="w-full max-w-lg bg-white rounded-xl shadow-lg p-6 md:p-8 transition-all duration-300 hover:shadow-xl mb-8">
        ...
        {shortUrl && (
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
            <p className="text-sm font-medium text-slate-600 mb-2">Tu URL corta:</p>
      ...
      <div className="mt-12 w-full max-w-5xl">
        <h2 className="text-2xl font-semibold text-center text-slate-800 mb-8">¿Por qué usar SnapLink?</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-medium mb-2 text-slate-800">Rápido y Simple</h3>
            <p className="text-slate-600">Acorta URLs en segundos sin necesidad de registrarte.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 className="text-lg font-medium mb-2 text-slate-800">En la Nube</h3>
            <p className="text-slate-600">Accede a tus enlaces acortados desde cualquier dispositivo.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 className="text-lg font-medium mb-2 text-slate-800">Seguro</h3>
            <p className="text-slate-600">Enlaces confiables y protegidos para compartir con confianza.</p>
          </div>
        </div>
      </div>

      {/* Footer */}
      <footer className="w-full max-w-5xl mt-16 mb-8 text-center text-slate-500 text-sm">
        <p>&copy; {new Date().getFullYear()} SnapLink. Todos los derechos reservados.</p>
      </footer>
    </main>
  );
}
